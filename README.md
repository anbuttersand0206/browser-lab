...
- **アルゴリズム可視化コース** — 19 種のアルゴリズムをステップ実行・速度調整しながら視覚的に学べる環境
...
19 種のアルゴリズムをステップ実行・速度調整しながら視覚的に学べます。

| カテゴリ | アルゴリズム |
|----------|-------------|
| ソート | バブル・選択・挿入・マージ・クイック・ヒープ |
| 探索 | 線形・二分探索、BFS・DFS・A\* |
| クラシック | ハノイの塔、フィボナッチ数列、ユークリッド互除法、モンテカルロ法 |
| 機械学習の基礎 | 畳み込み（CNN）、プーリング、k-means クラスタリング、パーセプトロン |
...
左サイドバーから 19 種のアルゴリズムを選択して可視化を開始できます。
